...
cd $HOME/pkgbuilds/cadence-claudia
...
yay -S zsh-plugin-wd-git zsh-fast-syntax-highlighting-git navi pyradio-git rstudio-desktop-bin faustlive-git htop-vim-git xcwd-git ladish python2-distutils-extra
