...
yay -S zsh-plugin-wd-git zsh-fast-syntax-highlighting-git navi pyradio-git mongodb-bin mongodb-tools-bin neovide rstudio-desktop-bin faustlive-git htop-vim-git xcwd-git
